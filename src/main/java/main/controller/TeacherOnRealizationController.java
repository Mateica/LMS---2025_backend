...
public class TeacherOnRealizationController implements ControllerInterface<TeacherOnRealizationDTO> {
			...
			teachersOnRealization.add(new TeacherOnRealizationDTO(p.getId(),
						...
						new SubjectRealizationDTO(p.getSubjectRealization().getId(),
								...
								new SubjectDTO(p.getSubjectRealization().getSubject().getId(),
										...
										p.getSubjectRealization().getSubject().getNumberOfClasses(), 
										p.getSubjectRealization().getSubject().getNumberOfPractices(),
										p.getSubjectRealization().getSubject().getOtherTypesOfClasses(),
										p.getSubjectRealization().getSubject().getResearchWork(), 
										p.getSubjectRealization().getSubject().getClassesLeft(),
										p.getSubjectRealization().getSubject().getNumberOfSemesters(),
										new YearOfStudyDTO(p.getSubjectRealization().getSubject().getYearOfStudy().getId(),
												p.getSubjectRealization().getSubject().getYearOfStudy().getYearOfStudy(),null, null),
										new OutcomeDTO(p.getSubjectRealization().getSubject().getOutcome().getId(),
												p.getSubjectRealization().getSubject().getOutcome().getDescription(), 
												null, null, null, p.getSubjectRealization().getSubject().getOutcome().getActive()),
										new ArrayList<SubjectRealizationDTO>(),
										new SubjectDTO(p.getSubjectRealization().getSubject().getPrerequisite().getId(), 
												p.getSubjectRealization().getSubject().getPrerequisite().getName(),
												p.getSubjectRealization().getSubject().getPrerequisite().getEcts(), 
												p.getSubjectRealization().getSubject().getPrerequisite().isCompulsory(), 
												null, null, null, null, null, null, null, null, null,null, null),
										p.getSubjectRealization().getSubject().getActive()), 
	    	...
	    	new TeacherOnRealizationDTO(t.getId(),
					...
					new SubjectRealizationDTO(t.getSubjectRealization().getId(),
							...
							new SubjectDTO(t.getSubjectRealization().getSubject().getId(),
									...
									new YearOfStudyDTO(t.getSubjectRealization().getSubject().getYearOfStudy().getId(),
											t.getSubjectRealization().getSubject().getYearOfStudy().getYearOfStudy(),null, null),
									new OutcomeDTO(t.getSubjectRealization().getSubject().getOutcome().getId(),
											t.getSubjectRealization().getSubject().getOutcome().getDescription(), 
											null, null, null, t.getSubjectRealization().getSubject().getOutcome().getActive()),
									new ArrayList<SubjectRealizationDTO>(),
									new SubjectDTO(t.getSubjectRealization().getSubject().getPrerequisite().getId(), 
											...
											null, null, null, null, null, null, null, null, null,null, null),
									t.getSubjectRealization().getSubject().getActive()), 
	...
	public ResponseEntity<TeacherOnRealizationDTO> create(@RequestBody TeacherOnRealizationDTO t) {
				...
				new SubjectRealization(t.getSubjectRealization().getId(),
						...
						new Subject(t.getSubjectRealization().getSubject().getId(),
								...
								new YearOfStudy(t.getSubjectRealization().getSubject().getYearOfStudy().getId(),
										t.getSubjectRealization().getSubject().getYearOfStudy().getYearOfStudy(),null, null),
								new Outcome(t.getSubjectRealization().getSubject().getOutcome().getId(),
										t.getSubjectRealization().getSubject().getOutcome().getDescription(), 
										null, null, null, 
										t.getSubjectRealization().getSubject().getOutcome().getActive()),
								...
								new Subject(t.getSubjectRealization().getSubject().getPrerequisite().getId(), 
										...
										t.getSubjectRealization().getSubject().getPrerequisite().getNumberOfSemesters(), null, null, null, null, 
										t.getSubjectRealization().getSubject().getPrerequisite().getActive()),
								t.getSubjectRealization().getSubject().getPrerequisite().getActive()), 
						t.getSubjectRealization().getActive()),
				new TeachingType(t.getTeachingType().getId(),
						t.getTeachingType().getName(), t.getTeachingType().getActive()),
				t.getActive()));
		...
		return new ResponseEntity<TeacherOnRealizationDTO>(new TeacherOnRealizationDTO(p.getId(),
						...
						new TeachingTypeDTO(p.getTeachingType().getId(),
								p.getTeachingType().getName(), p.getTeachingType().getActive()),
						p.getActive()), HttpStatus.CREATED);
	}
		...
		p = service.update(p);
				...
				return new ResponseEntity<TeacherOnRealizationDTO>(new TeacherOnRealizationDTO(p.getId(),
						...
						new TeacherDTO(p.getTeacher().getId(),
								...
								p.getTeacher().getLastName(),
								p.getTeacher().getUmcn(), p.getTeacher().getBiography(),
								titleDTOs, new ArrayList<TeacherOnRealizationDTO>(), null, null, 
								p.getTeacher().getActive()),
						new SubjectRealizationDTO(p.getSubjectRealization().getId(),
								null, null, null,
								new SubjectDTO(p.getSubjectRealization().getSubject().getId(),
